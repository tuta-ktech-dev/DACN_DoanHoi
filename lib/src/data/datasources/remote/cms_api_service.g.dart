...
class _CmsApiService implements CmsApiService {
  ...
  Future<AttendanceHistoryResponseModel> getAttendanceHistory({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AttendanceHistoryResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'student/attendance',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AttendanceHistoryResponseModel _value;
    try {
      _value = AttendanceHistoryResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
